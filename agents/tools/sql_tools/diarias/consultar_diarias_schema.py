"""Schemas da tool publica consultar_diarias."""
...
class ConsultarDiariasParams(SqlToolBaseSchema):
    ...
    def _normalize_ordenar_por(cls, value: Any) -> str:
        ...
        if normalized not in ALLOWED_DIARIAS_SORT_FIELDS:
    ...
    def _normalize_campos(cls, value: Any) -> list[str]:
        return normalize_selected_fields(
            value,
            allowed_fields=ALLOWED_DIARIAS_FIELDS,
            require_list=False,
            error_style="campos",
        )
