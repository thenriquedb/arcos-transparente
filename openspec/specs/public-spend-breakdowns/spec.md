...
When a citizen asks about gasto, gastos, custo, custou, or valor gasto in a supported public-spend domain, the system MUST return a detailed, auditable breakdown instead of only a single aggregated total by default.
