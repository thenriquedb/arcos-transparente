...
def upgrade() -> None:
    ...
    op.create_index("ix_receita_naturezas_identificacao_superior", "receita_naturezas", ["identificacao_superior"])
    ...
    op.create_table(
        ...
        sa.Column("natureza_id", sa.Integer(), sa.ForeignKey("receita_naturezas.id", ondelete="SET NULL"), nullable=True),
        ...
        sa.UniqueConstraint("data_arrecadacao", "unidade_gestora", "natureza_id", "fonte_recurso", name="uq_receita_arrec_base"),
    )
    ...
    op.create_index("ix_receita_arrecadacoes_data_arrecadacao", "receita_arrecadacoes", ["data_arrecadacao"])
    op.create_index("ix_receita_arrecadacoes_unidade_gestora", "receita_arrecadacoes", ["unidade_gestora"])
    ...
    op.create_table(
        ...
        sa.UniqueConstraint("data_lancamento", "tipo_receita", "tributo", "valor_lancado_exercicio", name="uq_receita_lanc_base"),
    )
    ...
    op.create_index("ix_receita_lancamentos_data_lancamento", "receita_lancamentos", ["data_lancamento"])
