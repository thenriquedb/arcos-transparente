...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("fornecedor_id", sa.Integer(), sa.ForeignKey("fornecedores.id", ondelete="SET NULL"), nullable=True),
        sa.Column("cnpj_cpf", sa.String(length=18), nullable=False),
        sa.Column("nome", sa.String(length=255), nullable=False),
    ...
    op.create_index("ix_instrumentos_contratuais_licitacao_id", "instrumentos_contratuais", ["licitacao_id"])
    op.create_index("ix_instrumentos_contratuais_numero_licitatorio", "instrumentos_contratuais", ["numero_licitatorio"])
    op.create_index("ix_instrumentos_contratuais_numero_instrumento", "instrumentos_contratuais", ["numero_instrumento"])
    op.create_index("ix_instrumentos_contratuais_tipo_contrato", "instrumentos_contratuais", ["tipo_contrato"])
    op.create_index("ix_instrumentos_contratuais_data_emissao", "instrumentos_contratuais", ["data_emissao"])
    op.create_index("ix_instrumentos_contratuais_data_expiracao", "instrumentos_contratuais", ["data_expiracao"])
    ...
    op.create_table(
        ...
        sa.Column("criado_em", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("atualizado_em", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("instrumento_id", sa.Integer(), sa.ForeignKey("instrumentos_contratuais.id", ondelete="CASCADE"), nullable=False),
        sa.Column("unidade_gestora", sa.String(length=120), nullable=True),
        ...
        sa.UniqueConstraint("instrumento_id", "numero_lote", "numero_item", name="uq_materia_instrumento_lote_item"),
    )
    op.create_index("ix_materias_instrumento_instrumento_id", "materias_instrumento", ["instrumento_id"])
...
def downgrade() -> None:
    ...
    op.drop_index("ix_instrumentos_contratuais_data_expiracao", table_name="instrumentos_contratuais")
    op.drop_index("ix_instrumentos_contratuais_data_emissao", table_name="instrumentos_contratuais")
    op.drop_index("ix_instrumentos_contratuais_tipo_contrato", table_name="instrumentos_contratuais")
    op.drop_index("ix_instrumentos_contratuais_numero_instrumento", table_name="instrumentos_contratuais")
    op.drop_index("ix_instrumentos_contratuais_numero_licitatorio", table_name="instrumentos_contratuais")
    op.drop_index("ix_instrumentos_contratuais_licitacao_id", table_name="instrumentos_contratuais")
