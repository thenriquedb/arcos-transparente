...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint("competencia_ano", "competencia_mes_nome", "servidor_id", "cargo_id", "lotacao_id", name="uq_folha_comp_servidor_cargo_lotacao"),
    )
    op.create_index("ix_folha_pagamentos_competencia_ano", "folha_pagamentos", ["competencia_ano"])
    op.create_index("ix_folha_pagamentos_competencia_mes_num", "folha_pagamentos", ["competencia_mes_num"])
    op.create_index("ix_folha_pagamentos_competencia_mes_nome", "folha_pagamentos", ["competencia_mes_nome"])
